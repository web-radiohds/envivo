jQuery(document).ready(function() {
    ...
    */
    ...
    /*
        Tooltips
    */
    $('.links a.button1').tooltip();
    $('.links a.button2').tooltip();
	$('.links a.button3').tooltip();
	$('.links a.button4').tooltip();
	$('.links a.button5').tooltip();
	$('.links a.button6').tooltip();
	$('.links a.button7').tooltip();
